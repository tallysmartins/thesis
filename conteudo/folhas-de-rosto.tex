...
\tituloport{Visualização Dinâmica Multiescala de Dados do Tráfego de Veículos}
...
\palavraschave{\emph{Bundling}, visualização, tráfego de veículos, cidades inteligentes.}

\keywords{\emph{Bundling}, visualization, traffic data, smart cities.}
