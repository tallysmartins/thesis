...
\begin{frame}{Visualização do Tráfego}
  \begin{figure}[!htb]
    \centering
    \includegraphics[width=100mm]{cluttered-map.png}
  \end{figure}
\end{frame}
}
...
% critério, e que no caso do transito esse critério tem q levar em conta a
% direção dos fluxos
...
% Ainda não sei sobre essa parte
...
\begin{frame}{Processo de Visualização do Tráfego}
  \begin{itemize}
    \item Tipo de dado
...
% Aqui eu falo os conjuntos que utilizaremos e como eles ajudarão a responder
