...
ser empregadas para mostrar uma transição entre os estados. Porém, a medida que o número
de partículas cresce  - alguns milhares de pontos - esse tipo de visualização começa a sofrer
...
a complexidade de análise de um grande conjunto trajetórias. Os fluxos
de deslocamento com origem e destino similares são então agrupados
em um nível de macro regiões, geralmente determinado por divisões administrativas.
...
ilustrado na Figura \ref{fig:interchange-circo}.
...
Apesar de facilitar a visualização, esse tipo de agregação abre mão das informações individuais de
cada trajetória em favor de uma visão condensada dos fluxos. Um outro desafio é representar
as multiplas variáveis de um conjunto de dados em uma mesma imagem e correlacioná-las.
Técnicas de bundling buscam resolver tais problemas de escalabilidade visual e tem se tornado
muito utilizadas em pesquisas de exploração de fluxos.
