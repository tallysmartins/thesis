...
tendências, periodicidades e anomalias nos dados ao longo de um eixo temporal \citep{70}.
...
\end{figure}
  ...
  Por outro lado, temos também alguns processos recorrentes que ocorrem
naturalmente em nosso mundo, que seguem estações, ou mesmo ciclos semanais ou
diários. Uma maneira comum de se visualizar essa periodicidade é através de um
leiaute radial, como ilustrado na Figura \ref{fig:periodic-time}. Na imagem, o
tempo é mostrado no eixo circular e cada anel do círculo representa um dia da
semana.  Os setores representam uma hora, com 24 setores no total que mostram a
quantidade de tráfego em um determinado ponto da cidade, mapeada em cores. A
vantagem de um leiaute radial é que ele evidencia padrões periódicos e a
desvantagem é que ele possui pouca eficiência espacial \citep{Chen2015}.
