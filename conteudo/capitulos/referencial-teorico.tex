...
\begin{programruledcaption}[Exemplo de arquivo map.xml que define a rede rodoviária da cidade]{Exemplo de arquivo map.xml que define a rede rodoviária da cidade. \\Fonte: \citet{mabs2017} \label{file:map.xml}}
...
\begin{programruledcaption}[Exemplo de arquivo trips.xml com a lista de viagens]{Exemplo de arquivo trips.xml com a lista de viagens. \\Fonte: \citet{mabs2017} \label{file:trips.xml}}
  \begin{lstlisting}[language=XML]
  <scsimulator_matrix>
...
\begin{programruledcaption}[Exemplo de arquivo de saída events.xml com os eventos da simulação]{Exemplo de arquivo de saída events.xml com os eventos da simulação. \\Fonte: \citet{mabs2017} \label{file:events.xml}}
  \begin{lstlisting}[language=XML]
  <events version="1.0">
