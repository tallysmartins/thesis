...
\emph{CUBu}, (que significa CUDA \emph{bundling}), é apresentado em
...
outros métodos \emph{IBB} \citep{adeb,lhuillier-fft:17}.
...
número de iterações (\emph{iterations}), tamanho do \emph{kernel} (\emph{kernel
