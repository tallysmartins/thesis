...
\begin{figure}[ht!]
  ...
  \caption[Densidade mapeada em escalas de cores gradiente]{Densidade mapeada em escala de cores gradiente. Fonte: \citet{Lhuillier2017}. \label{fig:direction}}
\end{figure}
...
da nossa solução.
  ...
  As questão de pesquisa \textbf{Q1}, relacionada ao uso do \emph{bundling}
