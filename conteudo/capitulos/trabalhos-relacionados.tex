...
% Sua
%análise mostra a locomoção de pessoas em estações de trem de Singapura, com
%dados de 1 milhão de passageiros contendo os pontos de entrada e saída do
%sistema de transporte. Já \citet{Andrienko2017} mostram a movimentação de
%bicicletas na cidade de Londres, também com dados de origem-destino das
%estações de início e fim das mais de 5 milhões de trajetórias durante 28
%semanas. Com isso conseguem verificar correlações das viagens com períodos sazonais do clima,
%verificar as diferenças no comportamento da população em dias da semana e em
%finais de semana, e o tipo predominante de viagens, que são habitualmente
%curtas e conectadas a outros meios de transporte.  \citet{Anita2017} apresenta uma nova técnica de \emph{bundling}, resultado de
