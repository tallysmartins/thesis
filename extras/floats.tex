...
\ifcsdef{chapter}
    % O novo ambiente se chama "xablau" ("\begin{program}") e a extensão
    % temporária é "lop"
    {\newfloat{xablau}{htbp}{loxablaus}[chapter]}
    {\newfloat{xablau}{htbp}{loxablaus}}

\captionsetup[xablau]{style=ruled}
\addto\extrasbrazil{
  \floatname{xablau}{Arquivo}
  \gdef\xablaulistname{Lista de Arquivos}
}

\addto\extrasenglish{
  \floatname{xablau}{File}
